...
function Withdraw({defaultLine}){
    ...
    function mtnFilter(){
        ...
        const result = mtnTransaction.agentWithdraw()
          setContent(result);
     }
    function airtelFilter(){
       setLine('airtel')
       const airtelTransaction = new AirtelTransaction(amount,'airtel')
       const result = airtelTransaction.agentWithdraw()
          setContent(result);
    }
      ...
      function handleChange(e) {
        ...
        if (!isNaN(amount)) {
            ...
            const airtelTransaction = new AirtelTransaction(amount,'airtel')
            const mtnTransaction = new MtnTransaction(amount,'mtn')
            const result = line === 'mtn' ? mtnTransaction.agentWithdraw() : airtelTransaction.agentWithdraw()
              setContent(result);
        }
